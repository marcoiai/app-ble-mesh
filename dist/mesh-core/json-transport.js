...
export async function packJsonForTransport(value, options) {
...
export async function unpackJsonFromTransport(envelope, options) {
    if (envelope.kind !== 'compact-json' || envelope.v !== 1)
        throw new Error('compact_json_envelope_unsupported');
